//
//  CrewMembersTableViewController.m
//  The Crew
//
...
@interface CrewMembersTableViewController () <UINavigationControllerDelegate>

@end

@implementation CrewMembersTableViewController
...
-(void)addFriend {
    ...
    AddFriendTVC * newFriendVC = [[AddFriendTVC alloc] init];
    
    newFriendVC.view.backgroundColor =  [UIColor colorWithRed:0.00
                                                            green:0.92
                                                             blue:0.92
                                                            alpha:1.0];
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ChatTVC * chatVC = [[ChatTVC alloc]init];
...
//#warning Incomplete method implementation.
    ...
    return self.friendsArrary.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PFObject * message = self.friendsArrary[indexPath.row];
